...
- Name: dynamic-renderer.spec.ts >> DynamicRenderer — 动态渲染引擎 >> Loyalty SaaS Admin 标题始终可见
- Location: e2e\dynamic-renderer.spec.ts:22:7
...
Locator: locator('h1:has-text("Loyalty SaaS Admin")')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('h1:has-text("Loyalty SaaS Admin")')
