...
import { useToast } from '@chartdb/components/toast/use-toast';
import {
    Pencil,
    Magnet,
    AlertTriangle,
...
import { areFieldTypesCompatible } from '@chartdb/lib/data/data-types/data-types';
import {
    calcTableHeight,
    findOverlappingTables,
    findTableOverlapping,
} from './canvas-utils';
import type { Graph } from '@chartdb/lib/graph';
import { removeVertex } from '@chartdb/lib/graph';
import type { ChartDBEvent } from '@chartdb/context/chartdb-context/chartdb-context';
import { cn, debounce, getOperatingSystem } from '@chartdb/lib/utils';
...
import {
    ...
    getTablesInArea,
} from '@chartdb/lib/utils/area-utils';
...
import type { DiagramFilter } from '@chartdb/lib/domain/diagram-filter/diagram-filter';
...
import { useDiff } from '@chartdb/context/diff-context/use-diff';
