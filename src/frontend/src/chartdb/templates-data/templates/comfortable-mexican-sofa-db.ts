...
import image from '@chartdb/assets/templates/comfortable-mexican-sofa-db.png';
import imageDark from '@chartdb/assets/templates/comfortable-mexican-sofa-db-dark.png';
