...
import { Tabs, TabsList, TabsTrigger } from '@chartdb/components/tabs/tabs';
import type { DatabaseClient } from '@chartdb/lib/domain/database-clients';
import { minimizeQuery } from '@chartdb/lib/data/import-metadata/utils';
import {
    databaseClientToLabelMap,
    databaseTypeToClientsMap,
    databaseEditionToClientsMap,
} from '@chartdb/lib/domain/database-clients';
import type { ImportMetadataScripts } from '@chartdb/lib/data/import-metadata/scripts/scripts';
    ...
    useEffect(() => {
        const loadScripts = async () => {
            const { importMetadataScripts } =
                await import('@chartdb/lib/data/import-metadata/scripts/scripts');
