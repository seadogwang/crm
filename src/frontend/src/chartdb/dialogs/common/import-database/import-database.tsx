...
import {
    ...
    DialogTitle,
} from '@chartdb/components/dialog/dialog';
import type { DatabaseType } from '@chartdb/lib/domain/database-type';
import { Editor } from '@chartdb/components/code-snippet/code-snippet';
import type { DatabaseEdition } from '@chartdb/lib/domain/database-edition';
import { useTranslation } from 'react-i18next';
import { ZoomableImage } from '@chartdb/components/zoomable-image/zoomable-image';
...
} from '@chartdb/lib/data/import-metadata/utils';
import {
    ResizableHandle,
    ResizablePanel,
    ResizablePanelGroup,
} from '@chartdb/components/resizable/resizable';
import { useTheme } from '@chartdb/hooks/use-theme';
import type { OnChange } from '@monaco-editor/react';
import { useDebounce } from '@chartdb/hooks/use-debounce-v2';
import { InstructionsSection } from './instructions-section/instructions-section';
import { parseSQLError } from '@chartdb/lib/data/sql-import';
import type { editor, IDisposable } from 'monaco-editor';
import { waitFor } from '@chartdb/lib/utils';
import {
    validateSQL,
    type ValidationResult,
} from '@chartdb/lib/data/sql-import/sql-validator';
import { SQLValidationStatus } from './sql-validation-status';
import { setupDBMLLanguage } from '@chartdb/components/code-snippet/languages/dbml-language';
import type { ImportMethod } from '@chartdb/lib/import-method/import-method';
import { detectImportMethod } from '@chartdb/lib/import-method/detect-import-method';
import { verifyDBML } from '@chartdb/lib/dbml/dbml-import/verify-dbml';
...
import {
    clearErrorHighlight,
    highlightErrorLine,
} from '@chartdb/components/code-snippet/dbml/utils';
