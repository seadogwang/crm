...
import logo from '@chartdb/assets/logo-2.png';
...
import { databaseSecondaryLogoMap } from '@chartdb/lib/databases';
...
} from '@chartdb/lib/domain/database-edition';
import {
    Avatar,
    AvatarFallback,
    AvatarImage,
} from '@chartdb/components/avatar/avatar';
