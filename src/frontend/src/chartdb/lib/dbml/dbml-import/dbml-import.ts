...
import { generateDiagramId, generateId, isStringEmpty } from '@chartdb/lib/utils';
import type { DBTable } from '@chartdb/lib/domain/db-table';
import { defaultSchemas } from '@chartdb/lib/data/default-schemas';
import type { Cardinality, DBRelationship } from '@chartdb/lib/domain/db-relationship';
...
import type { DataTypeData } from '@chartdb/lib/data/data-types/data-types';
import {
    findDataTypeDataById,
    getPreferredSynonym,
    requiresNotNull,
} from '@chartdb/lib/data/data-types/data-types';
import { defaultTableColor } from '@chartdb/lib/colors';
...
import { validateCheckConstraintWithDetails } from '@chartdb/lib/check-constraints/check-constraints-validator';
