...
import { generateDiagramId, generateId } from '@chartdb/lib/utils';
...
import { genericDataTypes } from '@chartdb/lib/data/data-types/generic-data-types';
import { defaultTableColor, viewColor } from '@chartdb/lib/colors';
import { DatabaseType } from '@chartdb/lib/domain/database-type';
import type { DBCustomType } from '@chartdb/lib/domain/db-custom-type';
import { DBCustomTypeKind } from '@chartdb/lib/domain/db-custom-type';
